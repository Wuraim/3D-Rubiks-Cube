export default class State {
    ...
    rotateUpClockwise() {
        ...
        // Échanger les bandes adjacentes
    ...
    rotateLeftClockwise() {
        ...
        for (let i = 0; i < 3; i++) {
            ...
            this.Back[2 - i][2] = downCol[i];  // On inverse ici l'ordre de la colonne back
        }
    }
    ...
    rotateRightClockwise() {
        ...
        for (let i = 0; i < 3; i++) {
            ...
            this.Back[2 - i][0] = upCol[i];  // On inverse ici l'ordre de la colonne back
        }
    }
    ...
    rotateRightCounterClockwise() {
        ...
        for (let i = 0; i < 3; i++) {
            ...
            this.Back[2 - i][0] = downCol[i];  // On inverse ici l'ordre de la colonne back
        }
    }
